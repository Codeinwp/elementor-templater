...
/**
 * Delete user meta 'elementemplater_ignore_neve_notice' on plugin deactivation
 */
function elementor_templater_deactivate() {
	$all_users = get_users(
		array(
...
register_deactivation_hook( __FILE__, 'elementor_templater_deactivate' );
